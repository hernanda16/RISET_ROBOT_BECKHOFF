...
char* comports[RS232_PORTNR] = {
    // @note : 0-15 are reserved for ttyS0 to ttyS15
    "/dev/ttyS0", "/dev/ttyS1", "/dev/ttyS2", "/dev/ttyS3", "/dev/ttyS4", "/dev/ttyS5",
    "/dev/ttyS6", "/dev/ttyS7", "/dev/ttyS8", "/dev/ttyS9", "/dev/ttyS10", "/dev/ttyS11",
    "/dev/ttyS12", "/dev/ttyS13", "/dev/ttyS14", "/dev/ttyS15",
    // @note : 16-21 are reserved for ttyUSB0 to ttyUSB5
    "/dev/ttyUSB0", "/dev/ttyUSB1", "/dev/ttyUSB2", "/dev/ttyUSB3", "/dev/ttyUSB4", "/dev/ttyUSB5",
    // @note : 22-37 are reserved for ttyACM0 to cuaU3
    "/dev/ttyAMA0", "/dev/ttyAMA1", "/dev/ttyACM0", "/dev/ttyACM1",
    "/dev/rfcomm0", "/dev/rfcomm1", "/dev/ircomm0", "/dev/ircomm1",
    "/dev/cuau0", "/dev/cuau1", "/dev/cuau2", "/dev/cuau3",
    "/dev/cuaU0", "/dev/cuaU1", "/dev/cuaU2", "/dev/cuaU3",
    // @note : 38-40 are reserved for Motor Right, Motor Left, and Motor Back in /dev/serial/by-path/
