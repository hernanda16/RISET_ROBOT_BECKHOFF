...
void Attacker::PrepKickoffHomeSingle() const
{
    ...
    case 100:
        if (motion->ruckigToPoint(FIELD_X_2_3, FIELD_Y_1_3, 90, 100, 90, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND)) {
    ...
    case 110:
        ...
        if (motion->ruckigToPoint(ball->pos.x, ball->pos.y, angleToTarget(ball->pos.x, ball->pos.y, *final_pose), 150, 70, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND)) {
...
void Attacker::PrepKickoffHomeDouble() const
{
    ...
    case 100:
        if (motion->ruckigToPoint3(FIELD_X_2_3, FIELD_Y_1_3, 90, 100, 90, NORMAL_OBSTACLE_BALL)) {
            game_sub_status_prep->value = 120;
        }
    ...
    case 120:
        motion->motionAroundPointAngle(FIELD_X_1_2, FIELD_Y_1_2, 170, angleToTarget(FIELD_X_1_2, FIELD_Y_1_2, *final_pose), 300, 170, 90, NORMAL_OBSTACLE);

        // if (ball->status > 0) {
        //     printf("Masuk liat bola\n");
        //     motion->motionAroundPointAngle(ball->pos.x, ball->pos.y, 160, angleToTarget(FIELD_X_1_2, FIELD_Y_1_2, *final_pose), 275, 150, 100, NORMAL_OBSTACLE);
        // } else {
...
void Attacker::PrepGoalkickHomeSingle() const
{
    ...
    case 102:
        ...
        if (ball->pos.x < FIELD_X_1_2) {
            if (motion->motionAroundBall(motion->RobotAngletoPoint(FIELD_X_0 + 70, FIELD_Y_1_2), motion->RobotAngletoBall(), 70, 150, 120)) {
                motion->manualMotion(0, 0, 0);
            }
        } else {
            if (motion->motionAroundBall(motion->RobotAngletoPoint(FIELD_X_1 - 70, FIELD_Y_1_2), motion->RobotAngletoBall(), 70, 120, 90)) {
                motion->manualMotion(0, 0, 0);
            }
        }
        if (counter > 150) {
...
void Attacker::PrepPenaltyHomeSingle() const
{
    ...
    case 0:
        ...
        motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2 - 100, robotAngletoEnemyGoal(*final_pose), 120, 70, NORMAL_OBSTACLE_BALL);
        break;
    case 1:
        // target_angle = RobotAngletoEnemyGoal(1, target_points);
        motion->motionAroundBall(robotAngletoEnemyGoal(*final_pose), robotAngletoEnemyGoal(*final_pose), 70, 120, 70, NORMAL_OBSTACLE);

        // if (motion->motionAroundBall(70,target_angle,120,70,NORMAL_OBSTACLE);)
        // {
        //     game_sub_status_prep->value = 2;
...
void Attacker::PrepKickoffAwaySingle() const
{
    ...
    case 0:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_3, motion->RobotAngletoBall(), 190, 90, NORMAL_OBSTACLE | NORMAL_OBSTACLE_BALL)) {
            game_sub_status_prep->value = 1;
        }
...
void Attacker::PrepKickoffAwayDouble() const
{
    ...
    printf("prep kickoff away %d\n", game_sub_status_prep->value);
    switch (game_sub_status_prep->value) {
    case 0:
        motion->ruckigToPoint3(FIELD_X_1_2 + 120, FIELD_Y_1_2 - 200, angleToTarget(FIELD_X_1_2, FIELD_Y_1_2, *final_pose), 125, 90, NORMAL_OBSTACLE | NORMAL_OBSTACLE_BALL);
...
void Attacker::PrepFreekickAwaySingle() const
{
    ...
    case 102:
        ...
        if (motion->motionAroundBall(motion->BallAngletoOurGoal() - 180, motion->RobotAngletoBall(), 200, 120, 60, NORMAL_OBSTACLE)) {
            motion->manualMotion(0, 0, 0);
        }
        if (counter > 150) {
            game_sub_status_prep->value = 100;
...
void Attacker::PrepFreekickAwayDouble() const
{
    ...
    switch (game_sub_status_prep->value) {
    case 0:
        printf("prep FREEKICK double att\n");
        game_sub_status_prep->value = 1;
        break;
    case 1:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2, 90, 120, 79, NORMAL_OBSTACLE_BALL)) {
            game_sub_status_prep->value = 2;
        }
    ...
    case 2:
        if (motion->ruckigToPoint3(ball->pos.x, ball->pos.y, atan2(ball->pos.y - FIELD_Y_0, ball->pos.x - FIELD_X_1_2) RAD2DEG, 120, 70, NORMAL_OBSTACLE_BALL) RAD2DEG) {
            game_sub_status_prep->value = 3;
        }
        if (pythagoras(final_pose->x, final_pose->y, ball->pos.x, ball->pos.y) < 330) {
            game_sub_status_prep->value = 3;
        }
        break;
    case 3:
        motion->motionAroundBall(atan2(ball->pos.y - FIELD_Y_0, ball->pos.x - FIELD_X_1_2) RAD2DEG, atan2(ball->pos.y - FIELD_Y_0, ball->pos.x - FIELD_X_1_2) RAD2DEG, 300, 120, 70, NORMAL_OBSTACLE);
        break;
    }
}
...
{
    game_sub_status_prep->reentry(0, 0.054);
    printf("Attacker::PrepGoalkickAwayDouble() %d\n", game_sub_status_prep->value);

    float angle_ball_to_owngoal = atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG;
    printf("prep goalkick AWAY double att   || %d\n", game_sub_status_prep->value);
    printf("n_nearest ball %d,ball_x %.2f, ball_y %.2f \n", bs_data->n_nearest_ball, ball->pos.x, ball->pos.y);
    if (ball->status > 0) {
        game_sub_status_prep->value = 1;
    }
    ...
    switch (game_sub_status_prep->value) {
    case 0:
        printf("prep goalkick double att\n");
        game_sub_status_prep->value = 1;
        break;
    case 1:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_2_3, 90, 120, 79, NORMAL_OBSTACLE | NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE_FRIEND)) {
            game_sub_status_prep->value = 2;
        }
        ...
        break;
    case 2:
        if (motion->ruckigToPoint3(ball->pos.x, ball->pos.y, atan2(ball->pos.y - FIELD_Y_0, ball->pos.x - FIELD_X_1_2) RAD2DEG, 120, 70, NORMAL_OBSTACLE | NORMAL_OBSTACLE_BALL)) {
            game_sub_status_prep->value = 3;
        }
        if (pythagoras(final_pose->x, final_pose->y, ball->pos.x, ball->pos.y) < 330) {
            game_sub_status_prep->value = 3;
...
void Attacker::PrepCornerAwaySingle() const
{
    ...
    case 100:
        ...
        if (motion->motionAroundBall(atan2(ball->pos.y - FIELD_Y_1_2, ball->pos.x - FIELD_X_1_2) RAD2DEG, motion->RobotAngletoBall(), 200, 120, 70, NORMAL_OBSTACLE)) {
            motion->manualMotion(0, 0, 0);
        }
        if (counter > 150) {
            game_sub_status_prep->value = 10;
...
void Attacker::PrepCornerAwayDouble() const
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_3, -90, 120, 79, NORMAL_OBSTACLE)) {
            game_sub_status_prep->value = 2;
        }
    ...
    case 2:
        if (ball->pos.x < FIELD_X_1_2) {
            motion->ruckigToPoint3(FIELD_X_1_2 - 100, 160, angleToTarget(ball->pos.x, ball->pos.y, *final_pose), 120, 70, NORMAL_OBSTACLE);
        } else {
            motion->ruckigToPoint3(FIELD_X_1_2 + 100, 160, angleToTarget(ball->pos.x, ball->pos.y, *final_pose), 120, 70, NORMAL_OBSTACLE);
        }

        // if (motion->ruckigToPoint3(ball->pos.x, ball->pos.y, atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, 120, 70, NORMAL_OBSTACLE_BALL)) {
        //     game_sub_status_prep->value = 3;
        // }
        // if (pythagoras(final_pose->x,final_pose->y, ball->pos.x, ball->pos.y) < 330)
        // {
        ...
        break;
    case 3:
        motion->motionAroundBall(atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, 300, 120, 70, NORMAL_OBSTACLE);
        break;
...
void Attacker::PrepThrowinAwayDouble() const
{
    ...
    switch (game_sub_status_prep->value) {
    case 0:
        printf("prep throwin double att\n");
        game_sub_status_prep->value = 1;
        break;
    case 1:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2, 90, 120, 79, NORMAL_OBSTACLE_BALL)) {
...
void Attacker::PrepDropBallSingle() const
{
    ...
    case 101:
        ...
        break;
    case 103:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2 + 100, -90, 120, 70, NORMAL_OBSTACLE_BALL))
            game_sub_status_prep->value = 101;
        if (ball->status > 0) {
            game_sub_status_prep->value = 101;
        }
        break;
    case 102:
        if (motion->motionAroundBall(atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, 250, 120, 70, NORMAL_OBSTACLE_BALL)) {
            game_sub_status_prep->value = 105;
        }
...
void Attacker::PrepDropBallDouble() const
{
    ...
    case 100:
        ...
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2, 90, 120, 70, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND))
            game_sub_status_prep->value = 101;

        break;

    case 101:
        if (motion->ruckigToPoint3(ball->pos.x, ball->pos.y, angleToTarget(ball->pos.x, ball->pos.y, *final_pose), 120, 70, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND))
            game_sub_status_prep->value = 101;

        if (pythagoras(final_pose->x, final_pose->y, ball->pos.x, ball->pos.y) < 170) {
            game_sub_status_prep->value = 105;
        }
    ...
    case 104:
        ...
        break;
    case 103:
        if (motion->ruckigToPoint3(FIELD_X_1_2, FIELD_Y_1_2 + 100, -90, 120, 70, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND))
            game_sub_status_prep->value = 101;
        if (ball->status > 0 || bs_data->n_nearest_ball > 0) {
            game_sub_status_prep->value = 101;
        }
        break;
    case 102:
        if (motion->motionAroundBall(atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, motion->RobotAngletoBall(), 300, 120, 70, NORMAL_OBSTACLE_BALL | NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND)) {
            game_sub_status_prep->value = 105;
        }

        break;
    case 105:
        motion->motionAroundBall(atan2(ball->pos.y - 0, ball->pos.x - 400) RAD2DEG, motion->RobotAngletoBall(), 150, 120, 70, NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND);
        break;
    }
}
...
void Attacker::PrepparationGlobalDynamic() const
{
    ...
    LogWithColor("white", "Attacker::PrepparationGlobalDynamic() %d\n", game_sub_status_prep->value);
    switch (game_sub_status_prep->value) {
    case 0:
        if (*titik_final_positioning[0] > FLT_EPSILON && *titik_final_positioning[1] > FLT_EPSILON) {
            ...
            if (ball->status > 0)
                motion->motionToPoint(target_x_buffer, target_y_buffer, motion->RobotAngletoBall(), 250, 120, NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND | NORMAL_OBSTACLE_BALL);
            else
                motion->motionToPoint(target_x_buffer, target_y_buffer, 90, 250, 15, NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND | NORMAL_OBSTACLE_BALL);
        }
        break;
    }
}
...
void Attacker::GameMainDouble() const
{
    ...
    game_sub_status->reentry(0, 0.05);
    printf("Attacker::GameMainDouble() %d || %d\n", game_sub_status->value, *has_prep);
    ...
    case 1030: {
        ...
        if (motion->pivotMotion(target_sudut_shot, 170)) {
    ...
    case 1040:
        if (ball->is_caught == 0) {
            ...
            kickerControl(stm_data, NO_AIM, 15);
        }
        game_sub_status->timeout(99, 9);
        break;
        ...
        //     if (motion->pivotMotion(angleToTarget(330, 1200, *final_pose), 130)) {
        //         game_sub_status->value = 11;
        //     }
        //     game_sub_status->timeout(99, 9);
        //     break;
        ...
        // case 11:
        //     stm_data->global_kicker_position = 200;
        //     motion->pivotMotion(angleToTarget(325, 1200, *final_pose), 130);
        //     if (ball->is_caught == 0) {
        //         kickerControl(stm_data, THROTTLE_AIM | KICKER_POSITION_AIM, 40, 200);
        //     } else {
        //         game_sub_status->value = 99;
        //     }
        //     game_sub_status->timeout(99, 9);
    ...
    case 2:
        ...
        pos_robot_buffer[1] = final_pose->y;
        if (game_status->value - 128 == status_preparation_cornerkick_away) {
            if (motion->motionAroundBall(atan2(ball->pos.y - (FIELD_Y_1), ball->pos.x - FIELD_X_1_2) RAD2DEG, motion->RobotAngletoBall(), 200, 120, 70, NORMAL_OBSTACLE)) {
                game_sub_status->value = 20;
                pos_robot_buffer[0] = final_pose->x;
                pos_robot_buffer[1] = final_pose->y;
            }
    ...
    case 20:
        ...
        if (game_status->value - 128 == status_preparation_cornerkick_away) {
            ...
            motion->motionAroundBall(motion->BallAngletoEnemyGoal() - 180, motion->RobotAngletoBall(), 200, 120, 70, NORMAL_OBSTACLE);
        } else {
            LogWithColor("magenta", "HADAP BOLA : %.2f\n", motion->BallAngletoOurGoal() - 180);
            motion->motionAroundBall(motion->BallAngletoOurGoal() - 180, motion->RobotAngletoBall(), 200, 120, 70, NORMAL_OBSTACLE);
        }
...
void Attacker::HasBall() const
{
    ...
    case 4:
        ...
        if (motion->RobotDist2Point(pos_buffer[0], pos_buffer[1]) > 30) {
    ...
    case 10: {
        ...
        if (final_pose->y < 900) {
            if (obs_depan.status) {
                if (final_pose->x > FIELD_X_1_2)
                    motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1), 111, 100, NORMAL_OBSTACLE | INVERT_OBS);
                else
                    motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1), 111, 100, NORMAL_OBSTACLE | INVERT_OBS);
            } else {
                if (final_pose->x > FIELD_X_1_2)
                    motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1), 91, 100, NORMAL_OBSTACLE | INVERT_OBS);
                else
                    motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1), 91, 100, NORMAL_OBSTACLE | INVERT_OBS);
            }
        } else {
            motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1), 101, 100, NORMAL_OBSTACLE);
        }
        ...
        if (motion->RobotDist2Point(pos_buffer[0], pos_buffer[1]) > 300) {
            if (obs_depan.status) {
                pos_x_sebelum_gerak_maju = final_pose->x;
                pos_y_sebelum_gerak_maju = final_pose->y;
                has_ball_state.value = 20;
    ...
    case 20: {
        ...
        //? INI
        // float target_sudut_shot = buffer_target_goal.goal_tengah[0] < 400 ? motion->RobotAngletoPoint(300, 1200) : motion->RobotAngletoPoint(500, 1200);
    ...
    case 40: {
        ...
        // SPAM TENDANG
        if (ball->is_caught > 0) {
            kickerControl(stm_data, THROTTLE_AIM, 10); // ini pelang kalo diam
        }
        // else {
...
void Attacker::FriendHasBall() const
{
    ...
    motion->motionToPoint(buffer_x, buffer_y, motion->RobotAngletoBall(), 200, 100);
}
void Attacker::EnemyHasBall() const
{
    ...
    case 10:
        ...
        if (motion->motionAroundBall(sudut_hadap_lawan - 180, motion->RobotAngletoBall(), 50, 150, 90))
            enemy_has_ball_state.value = 0;
...
void Attacker::WildBall() const
{
    ...
    LogWithColor("green", "WILDBALL %d POS [%.2f %.2f]\n", wild_ball_state.value,
        final_pose->x, final_pose->y);
...
void Attacker::Roaming(int default_state) const
{
    ...
    case 21:
        if (motion->ruckigToPoint(FIELD_X_1_2 - 190, FIELD_Y_1_2 - 190 + 100, motion->RobotAngletoPoint(FIELD_X_1_2, FIELD_Y_1_2) - 180, 130, 75, NORMAL_OBSTACLE_FRIEND | NORMAL_OBSTACLE)) {
            roaming_state.value = 3;
        }

        if (motion->RobotDist2Point(FIELD_X_1_2 - 190, FIELD_Y_1_2 - 190 + 100) < 200) {
            roaming_state.value = 3;
        }
        break;
    case 3:
...
void Attacker::BlockEnemy() const
{
    ...
    if (ball->pos.y < FIELD_Y_1_4 && bs_data->n_active_robot > 1) {
        /**
         * JARAK OBSTACLE KE BOLA > 100
         * POS OBSTACLE 240 < Y < 750
         * POS Y BOLA < POS Y OBSTACLE
         */
        // if (obstacle.status && jarak_obstacle_ke_bola > 100 && obstacle.pos_y > FIELD_Y_1_5 && obstacle.pos_y < FIELD_Y_1_2 + 150 && obstacle.pos_y > ball->pos.y) {
        ...
        //         50,
        //         80, 60, INVERT | NORMAL_OBSTACLE_FRIEND);
        // } else {
        //     motion->motionAroundPointAngle(FIELD_X_1_2, FIELD_Y_1_2,
        //         atan2f(FIELD_Y_1_2 - ball->pos.y, FIELD_X_1_2 - ball->pos.x) RAD2DEG,
        //         motion->RobotAngletoBall(),
        //         150,
        //         80, 60, NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND | INVERT);
        // }
        motion->motionAroundPointAngle(FIELD_X_1_2, FIELD_Y_1_2, atan2f(FIELD_Y_1_2 - ball->pos.y, FIELD_X_1_2 - ball->pos.x) RAD2DEG, motion->RobotAngletoBall(), 150, 80, 60, NORMAL_OBSTACLE | NORMAL_OBSTACLE_FRIEND | INVERT);
    } else {
